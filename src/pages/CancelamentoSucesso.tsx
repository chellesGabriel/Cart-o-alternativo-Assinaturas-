...
export default function CancelamentoSucesso() {
  ...
  const handleClose = () => navigate('/assinaturas')
  ...
  return (
    <div className="fixed inset-0 z-[1000] flex flex-col bg-[#f0f0f0]">
      ...
      <div className="flex-1 overflow-auto flex justify-center">
        <div className={`bg-white flex flex-col gap-8 items-center p-4 md:p-6 ${isMobile ? 'w-full mt-4' : 'w-[560px] mt-16 rounded-lg h-fit'}`}>
          ...
          <div className="flex flex-col gap-8 items-center w-full">
            ...
            <div className="flex flex-col gap-4 items-center w-full">
              ...
              <Text className="text-sm text-center">
                Que pena ver você partir, sentiremos sua falta!
              </Text>
            </div>
          </div>

          {/* Access info box */}
          <div className="bg-[#e1eaf7] rounded p-4 w-full">
            <Text className="text-sm">
              Você terá acesso ao conteúdo até {accessDate} (fim do período pago)
            </Text>
          </div>
